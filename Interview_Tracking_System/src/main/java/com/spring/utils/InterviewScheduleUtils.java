...
public class InterviewScheduleUtils {
		...
		public static List<ITS_TBL_Interview_Schedule> convertScheduleEntityListToScheduleList(List<ITS_TBL_Interview_Schedule_Entity> scheduleEntityList) {
			...
			Consumer<ITS_TBL_Interview_Schedule_Entity> consumer = (ITS_TBL_Interview_Schedule_Entity scheduleEntity)->scheduleList.add(convertScheduleEntityToScheduleAll(scheduleEntity));
		...
		public static ITS_TBL_Interview_Schedule convertScheduleEntityToScheduleAll(ITS_TBL_Interview_Schedule_Entity scheduleEntity) {
