...
public class AdminController {
	...
	public Object getFreeInterviewerList(@RequestHeader (name="date") String date,
			@RequestHeader (name="time") String time,@RequestHeader(name="auth-token") String authToken,@PathVariable(value="panel")String panel){
